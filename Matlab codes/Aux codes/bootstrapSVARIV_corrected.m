function [bootwold, upper, lower, boot_beta] = bootstrapSVARIV_corrected(instz, y,p,c,beta,residuals,nboot1,horizon,prc,nboot2)
...
for b=1:nboot1
    ...
    [varboot, instrument] = bootstrapVARIV(instz,y,p,c,beta,residuals);
...
[bootwold, upper, lower, boot_beta] = bootstrapSVARIV(instrument,y,p,c,Beta,residuals,nboot2,horizon,prc);
