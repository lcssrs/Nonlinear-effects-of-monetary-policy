function [bootchol, upper, lower, boot_beta] = bootstrapChol(y,p,c,beta,residuals,nboot,horizon,prc,cumulate,scaling)
...
for b=1:nboot
    ...
    if nargin > 9
        cholirf_loop = choleskyIRF(wold_loop, S_loop, scaling);
    else
